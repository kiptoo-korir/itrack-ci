...
<?php $errors = session()->getFlashdata('message') ?? null; ?>
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST"
                        action="<?php routePath('login'); ?>">
                        <?php csrf_field(); ?>
                        <div class="form-group row">
                            <label for="email" class="col-md-4 col-form-label text-md-right">Email Address</label>
                            <div class="col-md-6">
                                <input id="email" type="email"
                                    class="form-control <?php echo ($errors && $errors['email']) ? 'is-invalid' : ''; ?>"
                                    name="email"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password"
                                    class="form-control <?php echo ($errors && isset($errors['password'])) ? 'is-invalid' : ''; ?>"
